...
import com.seohalabs.moduerp.organization.employee.application.RegisterEmployeeResult;
...
public class EmployeeController {
  ...
  @PostMapping
  public Mono<ResponseEntity<RegisterEmployeeResult>> register(
      @RequestBody RegisterEmployeeRequest request) {
    return registerService
        .handle(EmployeeMapper.INSTANCE.toCommand(request))
  ...
  public Mono<ResponseEntity<Void>> resign(@PathVariable Long id) {
    return resignService
        .handle(new ResignEmployeeCommand(id))
  ...
  public Mono<ResponseEntity<Void>> grantHrManager(@PathVariable Long id) {
    return grantHrManagerService
        .handle(new GrantHrManagerCommand(id))
        .thenReturn(ResponseEntity.<Void>ok().build());
  }
  ...
  public Mono<ResponseEntity<Void>> revokeHrManager(@PathVariable Long id) {
    return revokeHrManagerService
        .handle(new RevokeHrManagerCommand(id))
        .thenReturn(ResponseEntity.<Void>ok().build());
  }
