...
import com.seohalabs.moduerp.organization.application.command.GrantHrManagerCommand;
import com.seohalabs.moduerp.organization.application.command.GrantHrManagerService;
import com.seohalabs.moduerp.organization.application.command.RegisterEmployeeService;
import com.seohalabs.moduerp.organization.application.command.ResignEmployeeCommand;
import com.seohalabs.moduerp.organization.application.command.ResignEmployeeService;
import com.seohalabs.moduerp.organization.application.command.RevokeHrManagerCommand;
import com.seohalabs.moduerp.organization.application.command.RevokeHrManagerService;
import com.seohalabs.moduerp.organization.application.query.EmployeeResult;
import com.seohalabs.moduerp.organization.application.query.FindEmployeeQuery;
import com.seohalabs.moduerp.organization.application.query.FindEmployeeService;
import com.seohalabs.moduerp.organization.application.query.FindEmployeesQuery;
import com.seohalabs.moduerp.organization.application.query.FindEmployeesService;
